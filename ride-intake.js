...
window.RideIntake = (function () {
  ...
  var _RIDE_T = {
    en: {
      ...
      unavailHeading:   'No Immediate Rides Right Now',
      unavailBody:      'No drivers on shift at this moment — but you can <strong>schedule any future pickup</strong>. Use the form to pick a date and we\'ll confirm availability.',
      callNow:          'Call Now',
    ...
    vi: {
      ...
      unavailHeading:   'Chưa Có Xe Ngay Lúc Này',
      unavailBody:      'Tài xế chưa có lịch trống lúc này — nhưng bạn có thể <strong>đặt chuyến cho ngày khác</strong>. Điền form để chọn ngày giờ và chúng tôi sẽ xác nhận.',
      callNow:          'Gọi Ngay',
    ...
    es: {
      ...
      unavailHeading:   'Sin Conductores Disponibles Ahora',
      unavailBody:      'No hay conductores de turno en este momento — pero puede <strong>programar un viaje futuro</strong>. Elija una fecha y confirmaremos la disponibilidad.',
