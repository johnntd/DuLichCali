...
var _UI_STRINGS = {
  en: {
    ...
    hpGroupTripTitle:'Plan a Group Trip with AI', hpGroupTripSub:'Multiple families, one shared visual itinerary + arrival plan',
  ...
  vi: {
    ...
    hpGroupTripTitle:'Lên Kế Hoạch Chuyến Đi Nhóm Bằng AI', hpGroupTripSub:'Nhiều gia đình, một lịch trình trực quan chung + kế hoạch đến nơi',
  ...
  es: {
    ...
    hpGroupTripTitle:'Planea un Viaje Grupal con AI', hpGroupTripSub:'Varias familias, un itinerario visual compartido + plan de llegada',
...
const HOMEPAGE_MARKETPLACE_ENTRIES = [
  ...
  },
  {
    ...
    featuredRegions: ['oc'],
    name: 'Mobile Barber — Orange County',
    city: 'Orange County',
    shortPromoText: 'In-home haircuts across Orange County. AI matches you with the nearest barber.',
    ...
    ctaText: 'Find My Barber',
    availabilityLabel: 'Book Now',
    availabilityStatus: 'now'
  },
  {
    id: 'mobile-barber-bayarea',
    category: 'barber',
    active: true,
    homepageActive: true,
    featuredPriority: 1.5,
    featuredRegions: ['bayarea'],
    name: 'Mobile Barber — Bay Area',
    city: 'Bay Area',
    shortPromoText: 'In-home haircuts across the Bay Area. AI matches you with the nearest barber.',
