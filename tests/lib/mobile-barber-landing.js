...
function runMobileBarberLandingTests(test) {
  ...
  test('Mobile Barber page loads scoped CSS and versioned JS', function() {
    assertContains(html, '/mobile-barber/mobile-barber.css?v=20260527d');
    assertContains(html, '/mobile-barber/mobile-barber-data.js?v=20260527a');
    assertContains(html, '/mobile-barber/mobile-barber-booking.js?v=20260527a');
  ...
  test('Mobile Barber vendor route has a single-vendor page', function() {
    ...
    assertContains(vendorHtml, '/mobile-barber/mobile-barber.css?v=20260527d');
    ...
    assertContains(vendorHtml, '/mobile-barber/mobile-barber-data.js?v=20260527a');
    assertContains(vendorHtml, '/mobile-barber/mobile-barber-booking.js?v=20260527a');
    assertContains(vendorHtml, '/ai-engine.js?v=20260524a');
    assertContains(vendorHtml, '/mobile-barber/mobile-barber-agent.js?v=20260525i');
    ...
    assertContains(vendorHtml, '/mobile-barber/mobile-barber-vendor.js?v=20260527a');
  ...
  test('Mobile Barber dashboard route and assets are isolated', function() {
    ...
    assertContains(dashboardHtml, '/mobile-barber/mobile-barber-data.js?v=20260527a');
    assertContains(dashboardHtml, '/mobile-barber/mobile-barber-booking.js?v=20260527a');
    assertContains(dashboardHtml, '/mobile-barber/mobile-barber-dashboard.js?v=20260527c');
    assertContains(dashboardHtml, '/mobile-barber/mobile-barber.css?v=20260527d');
