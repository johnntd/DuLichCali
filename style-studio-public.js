...
(function (root) {
  ...
  var SS_STRINGS = {
    en: {
      ...
      err_MASTER_BLOCKED: 'This photo couldn’t be processed. Please use a clear, front-facing photo of one person with a plain background — no filters, sunglasses, hats, or group shots.',
    ...
    vi: {
      ...
      err_MASTER_BLOCKED: 'Không xử lý được ảnh này. Vui lòng dùng ảnh rõ nét, nhìn thẳng, chỉ một người, nền đơn giản — không dùng bộ lọc, kính râm, mũ nón hay ảnh chụp nhóm.',
    ...
    es: {
      ...
      err_MASTER_BLOCKED: 'No se pudo procesar esta foto. Usa una foto nítida y de frente de una sola persona con fondo sencillo — sin filtros, gafas de sol, gorras ni fotos de grupo.',
