...
function runMobileBarberLandingTests(test) {
  ...
  test('Mobile Barber page loads scoped CSS and versioned JS', function() {
    assertContains(html, '/mobile-barber/mobile-barber.css?v=20260525ag');
    ...
    assertContains(html, '/mobile-barber/mobile-barber.js?v=20260525ad');
  });
  ...
  test('Mobile Barber vendor route has a single-vendor page', function() {
    ...
    assertContains(vendorHtml, '/mobile-barber/mobile-barber.css?v=20260525ag');
    ...
    assertContains(vendorHtml, '/mobile-barber/mobile-barber-data.js?v=20260525g');
    assertContains(vendorHtml, '/mobile-barber/mobile-barber-booking.js?v=20260525ac');
    ...
    assertContains(vendorHtml, '/mobile-barber/mobile-barber-vendor.js?v=20260525ae');
  ...
  test('Mobile Barber dashboard route and assets are isolated', function() {
    ...
    assertContains(dashboardHtml, '/mobile-barber/mobile-barber.css?v=20260525ag');
